  ...
  return (
    ...
    <Form>
        <Form.Group className="mb-3" controlId="formBasicNombre">
            ...
            <Form.Control type='text' placeholder='Ingrese un numero' onChange={(e)=>getN1(e.currentTarget.value)}></Form.Control>
        </Form.Group>
        <Form.Group className="mb-3" controlId="formBasicApellido">
            <Form.Label>Numero 2:</Form.Label>
            <Form.Control type='text' placeholder='Ingrese un numero' onChange={(e)=>getN2(e.currentTarget.value)}></Form.Control>
        </Form.Group>
